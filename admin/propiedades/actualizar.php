...
$imagenPropiedad = $propiedad['imagen']; // Mantener la imagen existente
    ...
    if (empty($errores)) {
        ...
        if ($propiedad) {
            ...
            if (isset($_FILES['imagen']) && $_FILES['imagen']['error'] === UPLOAD_ERR_OK) {
                ...
                // Si no se sube una nueva imagen, conservar la imagen actual
...
<main class="contenedor seccion">
    ...
    <form class="formulario" method="POST"  enctype="multipart/form-data">
        <fieldset>
            ...
            <img src="/imagenes/<?php echo $imagenPropiedad ; ?>" alt="Imagen de la Propiedad" class="imagen-actualizar">
